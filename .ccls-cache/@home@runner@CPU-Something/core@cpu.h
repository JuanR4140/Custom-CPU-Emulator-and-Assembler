...
enum opcodes{
  ...
  INS_STH_REG = 0x11, // str ax, bx (high 8 bits)
  INS_STL_REG = 0x12, // str ax, bx (low  8 bits)
  INS_STR_ADR = 0x13, // str ax, $100
  INS_STH_ADR = 0x14, // str ax, $100 (high 8 bits)
  INS_STL_ADR = 0x15, // str ax, $100 (low  8 bits)
  ...
  INS_ADD_ADR = 0x42, // add $100, 5

  INS_SUB_VAL = 0x50, // sub ax, 5
  INS_SUB_REG = 0x51, // sub ax, bx
  INS_SUB_ADR = 0x52, // sub $100, 1

  INS_MUL_REG = 0x60, // mul ax, bx -> dx

  INS_DIV_REG = 0x70, // mul ax, bx -> dx
